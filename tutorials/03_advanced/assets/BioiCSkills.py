...
def DBBPickAndPlaceSkill(**kwargs):
    """Executes DBBPickAndPlaceSkill"""
    assetHandle.read_availableSkills()

    # read actual skilldata (SkillData) as reference
    skilldata = assetHandle.read_stSkillData("DBBPickAndPlaceSkill")
    ...
    result = assetHandle.skillExecHandler.executeSkill("DBBPickAndPlaceSkill")
